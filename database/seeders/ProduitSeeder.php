...
class ProduitSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('produit')->insert([
            ...
            'description' => "Le Doudou Lapin Bonbon de Doudou et Compagnie sera rapidement le compagnon favori de votre enfant. Sa petite taille, ses longues oreilles et ses noeuds à mâchouiller le rendront parfaitement adapté aux petites mains de bébé. Livré avec une belle boîte cadeau, il sera un cadeau de naissance tout simplement parfait !",
            'prix' => 29.9,
            'actif' => true,
            'quantite' => 30,
        ...
        for ($i = 0; $i < 100; $i++) {
            ...
            DB::table('produit')->insert([
                ...
                'solde_pourcentage' => 0,
                'categorie_id' => random_int(7, 25),  // Les sous-catégories commence à l'id 7 et il y en a 19 en tout
